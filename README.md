...
To build the final jar and optimize the JMonolith application for production, run:
...
Then navigate to [http://localhost:8018](http://localhost:8018) in your browser.
