...
import it.jmonolith.repository.TipoEventoRepository;
import it.jmonolith.service.TipoEventoService;
...
/**
 * REST controller for managing {@link it.jmonolith.domain.TipoEvento}.
 */
@RestController
@RequestMapping("/api")
